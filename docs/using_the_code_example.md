...
The following example clones the "[LPComp Hiberate wakeup](https://github.com/Infineon/mtb-example-psoc-edge-lpcomp-hibernate-wakeup)" application with the desired name "LpCompHiberateWakeup" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-lpcomp-hibernate-wakeup --user-app-name LpCompHiberateWakeup --target-dir "C:/mtb_projects"
   ```
